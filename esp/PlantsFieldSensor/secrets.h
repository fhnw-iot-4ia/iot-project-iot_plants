...
#define SECRET_SSID "WorkingNetwork"	// replace MySSID with your WiFi network name
#define SECRET_PASS "wayy-gczk-gyrn-6zli"	// replace MyPassword with your WiFi password
...
#define MQTT_PASSWORD "iotmqtt"
#define MQTT_TOPIC "iotplants"
